...
public class ReportServer {
    ...
    public static String getReportData(String uid, String startdate,String enddate) {
        final String methodPath = "restcalorietracker.report/ReportForBar/" +uid+"/"+startdate+"/"+enddate;
        //initialise
        URL url = null;
        HttpURLConnection conn = null;
        String textResult = "";
