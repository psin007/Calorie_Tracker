...
public class MyHomeScreen  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        Button clearButton=(Button)vDisplayUnit.findViewById(R.id.edit_goal);
        clearButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                editGoal = (EditText)vDisplayUnit.findViewById(R.id.edgoal);
    ...
    public void welcomeMessage(){
        ...
        tvdate = (TextView)vDisplayUnit.findViewById(R.id.tv_currentdateandtime);
